...
public abstract class Minecraft implements Runnable {
	...
	public void startGame() throws LWJGLException {
		...
		try {
			...
			System.out.println("Controller support not available: " + var4.getMessage());
		}
										...
										if(Keyboard.getEventKey() == Keyboard.KEY_F11) {
											...
											if(this.currentScreen != null) {
												...
												if(Keyboard.getEventKey() == this.gameSettings.keyBindInventory.keyCode) {
													this.displayGuiScreen(new AC_GuiTMI(this.thePlayer));
												}
											...
											if(Keyboard.getEventKey() == this.gameSettings.keyBindToggleFog.keyCode) {
												this.gameSettings.setOptionValue(EnumOptions.RENDER_DISTANCE, !Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) && !Keyboard.isKeyDown(Keyboard.KEY_RSHIFT) ? Keyboard.KEY_ESCAPE : -1);
											}
										}
									}
								}
