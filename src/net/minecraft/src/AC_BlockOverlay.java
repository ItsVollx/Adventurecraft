...
/**
 * Overlay decorative block (cross-shaped, no collision).
 * Think: grass overlays, snow overlays, etc.
 */
public class AC_BlockOverlay extends Block implements AC_IBlockColor {
	public AC_BlockOverlay(int id, int tex) {
	...
	public int getRenderType() {
		return 1; // Cross shape (type 37 deferred)
	}
