...
public class GuiMainMenu extends GuiScreen {
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		byte var7 = 30;
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/acLogo.png"));
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		this.drawTexturedModalRect(var6 + 0, var7 + 0, 0, 0, 256, 31);
		this.drawTexturedModalRect(var6 + 256, var7 + 0, 0, 128, 64, 31);
		...
		GL11.glPopMatrix();
		this.drawString(this.fontRenderer, "AdventureCraft Beta 1.7.3", 2, 2, 5263440);
