...
public class ThreadDownloadResources extends Thread {
	...
	// Change this URL to download resources from your own server
	// Set to empty string "" to skip downloading and use local resources only
	public static String resourceUrl = "";

	public void run() {
		try {
			if(resourceUrl == null || resourceUrl.isEmpty()) {
				System.out.println("No resource URL set, loading local resources.");
				this.loadResource(this.resourcesFolder, "");
				return;
			}

			System.out.println("Downloading resources from: " + resourceUrl);
			URL var1 = new URL(resourceUrl);
